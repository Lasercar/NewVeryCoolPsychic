...
class PlayState extends MusicBeatState
{
    ...
    // Lasercar - Yeah well, the attached sprite stuff would have to be messily created in the lua script. I get that it'd shown off global lua scripts, but it wouldn't be a very good example or an optimal use of lua
