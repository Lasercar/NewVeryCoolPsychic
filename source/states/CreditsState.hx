...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Mind Games Crew'],
			['Riveren',			'riveren',		'Project Lead & Animator\n"Wait, I made this???"',										'https://x.com/riverennn',		'14967B'],
			['Shadow Mario',		'shadowmario',		'Main Programmer\n"WikiHow: How to handle fame."',										'https://x.com/Shadow_Mario_',	'444444'],
			['iFlicky',				'flicky',			'Main Composer\n"Berr dig a nerr nerr"',												'https://x.com/flicky_i',			'C549DB'],
			['longestsoloever',		'longestsoloever',	'Collaborated on Uproar\'s Instrumental\n"just make mine \'guitar guy\' or something”',	'https://x.com/longestsoloever',	'BC0011'],
			['Leomming',			'leomming',			'Additional Arts\n"Are Krampus furries? Discuss."',										'https://x.com/Leomming',			'FF8A7D'],
			['PJsVoiceArts',		'pjsvoicearts',		'Psychic and Spirit\'s Voice Actor\n“Praise the Sun! And let the Sun SHINE!”',			'https://x.com/PJsVoiceArts', 	'FE3E4F'],
			['lymph',				'lymph',			'Uproar\'s Charter\n"oh boy whats for dinner"',											'https://x.com/monterdash',		'666666'],
			['Join our Discord!',	'discord',			'If you dare...',																		'https://discord.gg/uE3vPYhXwR',		'5165F6'],
			[''],
			['Special Thanks'],
			['Salvati',				'salvati',			'Psychic\'s Soundfont Creator\n"Bottom text"',			'https://x.com/cyndacat76',	'33FFFF'],
			['slabraccoon',			'slabraccoon',		'Emotional Support Raccoon\n"*Feral growling*"',		'https://x.com/slabraccoon',	'BC5223'],
			[''],
			["Psych Engine Team"],
